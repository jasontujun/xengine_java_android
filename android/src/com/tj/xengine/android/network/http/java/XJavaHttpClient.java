...
public class XJavaHttpClient extends XBaseHttp {
    ...
    public XHttpResponse execute(XHttpRequest req) {
        ...
        XLog.d(TAG, "send http request. url=" + req.getUrl());
        ...
        try {
            ...
            XLog.d(TAG, "http response statusCode=" + statusCode);
...
//                ex.printStackTrace();
            ...
            javaResponse.setContentLength(connection.getContentLength());
...
//                }
    ...
    private HttpURLConnection handleRedirect(final XHttpConfig config,
        ...
        XLog.d(TAG, "need handleRedirect");
        ...
        while (redirectCount < config.getMaxRedirect()) {
            ...
            XLog.d(TAG, "redirect newUlr=" + newUrl);
            ...
            try {
                int statusCode = connection.getResponseCode();
                XLog.d(TAG, "redirect statusCode=" + statusCode);
